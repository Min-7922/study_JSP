...
<ul>
	...
	<li>사용자의 입력값이므로, 서버개발자가 값을 강제로 넣을 수 없다 (setParameter는 없다)</li>
	<!-- 사용자가 입력하는 값이므로 String이며 서버에서 마음대로 바꿀 수 없다 -->
</ul>
...
<ul>
	...
	<li>JSP 내장 객체에 저장해둘 수 있고, 내장객체에 따라 유효 범위가 다르다</li>
	...
	<!-- Object 타입이므로 자바의 모든 자료형을 받을 수 있다 -->
</ul>
...
<table>
	...
	<tr>
		<td>request</td>
		<td>
			현재 요청에 대해서만 사용할 attribute를 저장한다
