...
<ul>
	...
	<li>JSTL sql : JSP에서 SQL문을 이요하여 DB와 상호작용하기 위한 태그</li>
...
<ol>
	...
	<li>EL Tag는 JSP의 기본스펙이지만, JSP에는 라이브러리 파일을 /WEB-INF/lib 폴더에 넣어야 한다</li>
	<li>JSTL을 사용하기 위해서 상단에 tablib지시자를 이용하여 선언해야 쓸 수 있다</li>
</ol>
